...
onMounted(async () => {
  ...
  // Animation sequence: Start greeting, then transition to logo/main heading
  setTimeout(() => {
    isGreetingPhase.value = false
  }, 4000) // 4 seconds is plenty for home screen
})
      ...
      <div class="hero-inner">
        ...
        <div class="animation-stage">
          <transition name="greeting-slide" appear>
            <h1 v-if="isGreetingPhase" class="greeting-msg" key="greet">{{ greetingText }}</h1>
            <h1 v-else class="hero-heading" key="heading">What are we looking for?</h1>
          </transition>
        </div>
